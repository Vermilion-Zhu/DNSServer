...
- [DNSServer 项目说明文档](#dnsserver-项目说明文档)
  ...
  - [核心模块详解](#核心模块详解)
    ...
    - [5. DGA 检测模块 — `model_training/`](#5-dga-检测模块--model_training)
      - [4.1 特征工程 — `train_dga_model.py`](#41-特征工程--train_dga_modelpy)
      - [4.2 推理运行时 — `dga_runtime.py`](#42-推理运行时--dga_runtimepy)
      - [4.3 推理基准测试 — `bench_inference.py`](#43-推理基准测试--bench_inferencepy)
